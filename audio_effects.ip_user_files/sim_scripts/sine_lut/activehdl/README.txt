...
#
# Generated by export_simulation on Sun Mar 25 20:01:13 +0800 2018
#
################################################################################
...
switch to the './sine_lut.sh' script.

./sine_lut.sh -reset_run
...
./sine_lut.sh -noclean_files

For more information on the script, please type './sine_lut.sh -help'.
