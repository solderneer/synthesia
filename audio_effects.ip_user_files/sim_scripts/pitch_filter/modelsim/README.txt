...
#
# Generated by export_simulation on Sat Apr 07 20:29:24 +0800 2018
#
################################################################################
...
switch to the './pitch_filter.sh' script.

./pitch_filter.sh -reset_run
...
./pitch_filter.sh -noclean_files

For more information on the script, please type './pitch_filter.sh -help'.
