...
HD_PWD='C:/Users/Auora/Documents/tonedeaf/audio_effects.runs/pitch_filter_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pitch_filter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pitch_filter.tcl
