...
HD_PWD='C:/Users/Auora/Documents/tonedeaf/audio_effects.runs/sine_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sine_lut.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sine_lut.tcl
