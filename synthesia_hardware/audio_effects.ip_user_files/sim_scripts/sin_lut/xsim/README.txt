...
#
# Generated by export_simulation on Wed Mar 28 16:51:22 +0800 2018
#
################################################################################
...
switch to the './sin_lut.sh' script.

./sin_lut.sh -reset_run
...
./sin_lut.sh -noclean_files

For more information on the script, please type './sin_lut.sh -help'.
