...
HD_PWD='C:/Users/Auora/Desktop/audio_effects/audio_effects.runs/sin_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sin_lut.vds -m64 -mode batch -messageDb vivado.pb -notrace -source sin_lut.tcl
